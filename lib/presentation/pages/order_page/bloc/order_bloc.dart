  ...
  OrderBloc(this.datasource, this.cartDatasource)
    ...
    on<_GetAllHistoryOrder>((event, emit) async {
      ...
      try {
        ...
        result.fold(
              ...
              (r) => emit(OrderState.success(r, null, 0, null, null, )),
        );
      } catch (e) {
    ...
    on<_PostReOrderReward>((event, emit) async {
      ...
      try {
        ...
        result.fold(
              (l) => emit(const _Error(message: 'Oops, something went wrong. Please try again later')),
              (r) => emit(OrderState.success(null, null, 0, null, r, )),
        );
      } catch (e) {
        emit(_Error(message: e.toString()));
      }
    ...
    on<_GetAllHistoryOrderReward>((event, emit) async {
      ...
      try {
        ...
        result.fold(
              (l) => emit(const _Error(message: 'Oops, something went wrong. Please try again later')),
              (r) => emit(OrderState.success(null, r, 1, null, null, )),
        );
      } catch (e) {
        emit(_Error(message: e.toString()));
      }
    ...
    on<_GetCategoryOrder>((event, emit) async {
      ...
      try {
        ...
        await result.fold(
              ...
              (r) async => emit(OrderState.success(r, null, 0, null, null, )),
        );
      } catch (e) {
        emit(_Error(message: e.toString()));
      }
    ...
    on<_GetCategoryOrderReward>((event, emit) async {
      ...
      try {
        ...
        await result.fold(
              (l) async => emit(const _Error(message: 'Oops, something went wrong. Please try again later')),
              (r) async => emit(OrderState.success(null, r, 0, null, null,)),
        );
      } catch (e) {
        emit(_Error(message: e.toString()));
      }
      ...
      try {
        if (filterIndex == 0) {
          ...
          emit(result.fold(
                ...
                (r) => OrderState.success(r, null, filterIndex, null, null, ),
          ));
        } else {
          final result = await datasource.getFilterTypeOrderReward(event.query);
          emit(result.fold(
                (l) => const OrderState.error(message: 'Oops, something went wrong. Please try again later'),
                (r) => OrderState.success(null, r, filterIndex, null, null,),
          ));
        }
      } catch (e) {
