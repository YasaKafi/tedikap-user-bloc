...
class SectionButton extends StatefulWidget {
  SectionButton({super.key, this.linkCheckout, this.orderId, this.orderRewardId});
  String? linkCheckout;
  String? orderId;
      ...
      builder: (context, state) {
        return state.maybeWhen(
          ...
          success: (model, modelReward) {
            ...
            final bool statusOrderOngoing = model.order?.status == 'menunggu konfirmasi' || model.order?.status == 'pesanan diproses' || model.order?.status == 'pesanan siap diambil';
            final bool isCartItemEmpty = !(model.order?.cartItems ?? false);
            final bool isCartRewardItemEmpty = !(modelReward?.order?.cartItems ?? false);
                    ...
                    children: [
                      ...
                      CommonButton(
                        ...
                        onPressed: ()  {
                          ...
                          if (model.order != null || modelReward?.order != null){
