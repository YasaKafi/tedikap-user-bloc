...
class DetailProductState with _$DetailProductState {
  ...
  const factory DetailProductState.loading({@Default(false) bool isPostCartLoading, DetailProductResponseModel? model,
    DetailProductRewardResponseModel? modelReward,}) = _Loading;
