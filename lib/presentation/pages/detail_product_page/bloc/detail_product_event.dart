...
class DetailProductEvent with _$DetailProductEvent {
  ...
  const factory DetailProductEvent.postFavorite(int? productId) = _PostFavorite;
  const factory DetailProductEvent.checkFavorite(int? productId) = _CheckFavoriteProduct;
  ...
  const factory DetailProductEvent.getDetailItemCartReward(int cartId) = _GetDetailItemCartReward;
  ...
  const factory DetailProductEvent.updateCartReward(PostCartRewardRequestModel? model, int? id) = _UpdateCartReward;
}
