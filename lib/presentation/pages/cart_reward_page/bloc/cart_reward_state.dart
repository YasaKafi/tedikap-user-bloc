...
class CartRewardState with _$CartRewardState {
  ...
  const factory CartRewardState.success(
      {required CartRewardResponseModel? cartModel, required List<DetailProductRewardResponseModel?>? productDetails, required PatchQtyResponseModel? patchQtyModel, required DeleteCartItemResponseModel? deleteModel, }) = _Success;
