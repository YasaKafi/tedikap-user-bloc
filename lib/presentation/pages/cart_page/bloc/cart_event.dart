...
class CartEvent with _$CartEvent {
  ...
  const factory CartEvent.postOrder({required PostOrderRequestModel modelOrder, required void Function(String orderId, String linkCheckout) onOrderSuccess, required BuildContext context}) = _PostOrder;
